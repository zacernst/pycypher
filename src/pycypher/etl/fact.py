...
*   **Goldberg**: The `Goldberg` class is the central orchestrator within the `pycypher` library. `Fact` objects have a reference to this object, which allows them to query for other facts.
...
1.  ``AtomicFact``
    ...
    *   **Functionality:**
        ...
        *   Provides a common ``goldberg`` attribute.
...
2.  ``FactNodeHasLabel``
    ...
    *   **Attributes:**
        ...
        *   ``goldberg`` (Optional["Goldberg"]): A reference to the `Goldberg` object that contains this `Fact`.
    *   **Functionality:**
...
9.  ``FactCollection``
    ...
    *   **Attributes:**
        ...
        *   ``goldberg`` (Optional["Goldberg"]): A reference to the `Goldberg` object that contains this `Fact`.
    *   **Functionality:**
        *   ``__init__(self, facts: List[AtomicFact], goldberg: Optional["Goldberg"] = None)``: Initializes the ``FactCollection`` with a list of facts and an optional reference to the `Goldberg` object.
    ...
    *   **Example:**
        ...
        .. code-block:: python
            ...
            # Create a Goldberg Object
            goldberg = Goldberg()

            fact1 = FactNodeHasLabel("n123", "Person", goldberg=goldberg)
            fact2 = FactNodeHasAttributeWithValue("n123", "name", "Alice", goldberg=goldberg)
            fact_collection = FactCollection([fact1, fact2], goldberg=goldberg)
