...
1.  **``TableWriter`` (Abstract Base Class):**
    ...
    *   **Key Methods:**
        ...
        *   ``write(self, generator, entity: Optional[str] = None, goldberg: Optional[Goldberg] = None, **kwargs)``: An abstract method that must be implemented by subclasses to write data from a generator to the specified target.
        ...
        * `write_entity_table(self, goldberg: Goldberg, entity: str)`: write out all the rows for a particular entity type.
...
2.  **``ParquetTableWriter`` (Concrete Implementation):**
    ...
    *   **Key Methods:**
        *   ``write(self, generator, entity: str = None, goldberg: Goldberg = None, **kwargs)``: Writes data to a Parquet file.
...
3.  **``CSVTableWriter`` (Concrete Implementation):**
    ...
    *   **Responsibilities:**
        ...
        * Takes a generator that yields rows of data as dictionaries.
    *   **Key Methods:**
        *   ``write(self, generator, entity: Optional[str] = None, goldberg: Optional[Goldberg] = None, **kwargs)``: Writes data to a CSV file.
...
class TableWriter(ABC):
    ...
    def write(
        ...
        **kwargs,
        ...
        Args:
            ...
            goldberg (Optional[Goldberg]): The Goldberg instance. Defaults to None.
    ...
    def write_entity_table(self, goldberg: Goldberg, entity: str):
        ...
        the Goldberg instance and writes them using the concrete writer implementation.

        Args:
            goldberg (Goldberg): The Goldberg instance.
    ...
    def write(
        ...
        **kwargs,
        ...
        Args:
            ...
            goldberg (Goldberg, optional): A reference to the Goldberg object. Defaults to None.
    ...
    def write(
        ...
        **kwargs,
        ...
        Args:
            ...
            goldberg (Optional[Goldberg]): A reference to the Goldberg object. Defaults to None.
            **kwargs: additional keyword arguments.
        """
        fieldnames = sorted(
